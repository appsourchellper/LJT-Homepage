...
1. **SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond** (2025) — First author, with Yuanxiang Fan, Zhuo Jiang, Han Ding, Yongyi Hu, Chi Zhang, Yiqi Shi, Shitong Weng, Aili Chen, Shiqi Chen, Yunan Huang, Mozhi Zhang, Pengyu Zhao, Junjie Yan, Junxian He. Arxiv.

2. **On the Perception Bottleneck of VLMs for Chart Understanding** (2025) — First author, with Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. Arxiv.
